										...
										<div class="card card-body">
											<div class="row">
												...
												while ($resimCek=$resimSor->fetch(PDO::FETCH_ASSOC)) { 
													$yol="../ebook/".$resimCek['yol'];

													?>

													<a data-toggle="lightbox" data-gallery="example-gallery" href="<?php echo $yol ?>" class="col-sm-2">
														<img  alt="<?php echo $resimCek['sayfaNo'] ?> "  enctype="multipart/form-data" src="<?php echo $yol ?>" class="img-fluid"> 
