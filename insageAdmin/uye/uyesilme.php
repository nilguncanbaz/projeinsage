...
while ($kullaniciCek = $kullaniciSor->fetch(PDO::FETCH_ASSOC)) {?>
    ...
    default:
        echo "engellendi";
                                                    ...
                                                    <td align="center"><a
                                                            href="uyesilmeislemi.php?userID=<?php echo $kullaniciCek['userID'] ?>"
                                                            onClick="return confirm('Bu üyeyi silmek istediğinize emin misiniz?')"><button
                                                                class="btn btn-danger" type="submit" name="sil"><i
