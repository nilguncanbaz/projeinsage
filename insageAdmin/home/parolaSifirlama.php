...
//veritabanından kayıt sayısı 0 dönerse o email kayıtlı değildir
	...
	//mail adresi kayıtlıysa
		...
		$mail->CharSet  ="utf-8";
		$mail->Username = "bilgi@hirasyazilim.com"; // Gönderici adresiniz (e-posta adresiniz)
		$mail->Password = "Selcuk.23"; // Mail adresimizin sifresi
		$mail->SetFrom("bilgi@hirasyazilim.com", "Hiras Yazılım InSAGE"); //mailde görünecek adres ad
