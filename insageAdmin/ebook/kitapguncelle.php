						...
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">						
							<div class="card mb-8">
								...
								<div class="card-body">
									...
									<form method="post" class="demo-form" action="guncelle.php?ISBN=<?php echo $_REQUEST['ISBN'] ?>&pageSize=<?php echo $kullaniciCek['pageSize'] ?>&yol=<?php echo $kullaniciCek['yol'] ?>&tip=<?php echo $kullaniciCek['tip'] ?>&id=<?php echo $kullaniciCek['id']?>">
								...
								<input type="hidden" value="<?php echo $kullaniciCek['tip'] ?>" name="tip">
