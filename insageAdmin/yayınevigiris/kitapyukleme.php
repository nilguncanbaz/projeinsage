...
<body class="adminbody">
					...
					<div class="row">
						...
						<div class="col-xs-25 col-sm-25 col-md-25 col-lg-25 col-xl-25">						
											...
											<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><br>
												<div class="card mb-6">
													...
													<form action="icerikYukleme/yukle.php?ISBN=<?php echo $_REQUEST['ISBN'] ?>"method="post" enctype="multipart/form-data" id="yukle" >
														...
														<?php
														$klasor='../ebook/icerikYukleme/dosyalar/'.$_REQUEST['ISBN'].'/pages/';
                         ...
                         <form action="icerikYukleme/pdfyukle.php?ISBN=<?php echo $_REQUEST['ISBN'] ?>" method="post" enctype="multipart/form-data" id="yukle" >
                           ...
                           $kontrol='../ebook/icerikYukleme/dosyalar/'.$_REQUEST['ISBN'].'/pdfs/';
                           $dosya=false;
  																	...
  																	<div class="table-responsive">
  																		...
  																		<table class="table table-bordered">
  																			...
  																			<tbody>
  																				...
  																				$resimSor=$db->prepare("SELECT * from ebook_sayfa_resim where ISBN=:ISBN");
  																				...
  																				while ($resimCek=$resimSor->fetch(PDO::FETCH_ASSOC)) { 
  																					...
  																					<tr >
  																						...
  																						<td>
                                                <?php $yol="../ebook/".$resimCek['yol']; ?>
  																							<span style="float: left; margin-right:10px;"><img
  																								class="img-fluid" style="max-width:150px; height:auto;" src="<?php echo $yol ?>" /></span>
  																							</td>
                                                      ...
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <div class="card mb-3">
                                                            ...
                                                            <div class="card-body">
                                                              <form action="icerikYukleme/txtKaydet.php?ISBN=<?php echo $_REQUEST['ISBN'] ?>" method="post">
    ...
    $('#filer_example2').filer({
    	limit: <?php echo $sayfa; ?>,
    	maxSize: <?php echo $sayfa; ?>,
