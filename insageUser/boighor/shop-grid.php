					...
					<div class="col-lg-3 col-12 order-2 order-lg-1 md-mt-40 sm-mt-40">
						<div class="shop__sidebar">
							<aside class="wedget__categories poroduct--cat">
								<h3 class="wedget__title">KİTAP KATEGORİLERİ </h3>
								<ul>
									<li><a href="#">Biyoloji <span>(3)</span></a></li>
									<li><a href="#">Felsefe <span>(4)</span></a></li>
									<li><a href="#">Tarih <span>(6)</span></a></li>
									<li><a href="#">Sağlık <span>(7)</span></a></li>
									<li><a href="#">Mantık <span>(8)</span></a></li>
									<li><a href="#">Müzik <span>(9)</span></a></li>
									<li><a href="#">Bilişim <span>(13)</span></a></li>
									<li><a href="#">coğrafya <span>(20)</span></a></li>
								</ul>
							</aside>
							<aside class="wedget__categories pro--range">
								<h3 class="wedget__title">FİYAT ARALIĞI</h3>
											...
											<div class="slider__range--output">
												<div class="price__output--wrap">
													<div class="price--output">
														<span>Fiyat : </span><input type="text" value="200-1000">
													</div>
							...
							<aside class="wedget__categories poroduct--tag">
								<h3 class="wedget__title">ETİKETLER</h3>
								<ul>
							...
							<aside class="wedget__categories sidebar--banner">
								...
								<div class="text">
									<h2>Kampanya</h2>
									<h6>ŞİMDİ <br> <strong>40%</strong>İNDİRİMLİ</h6>
								</div>
							</aside>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="shop__list__wrapper d-flex flex-wrap flex-md-nowrap justify-content-between">
									...
									<p>40 sonuçtan 1–12 gösteriliyor</p>
