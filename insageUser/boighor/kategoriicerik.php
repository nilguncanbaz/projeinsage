				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							<h2 class="title__be--2"> Akademi <span class="color--theme">Kategorisi</span></h2>
							<p>Akademik kitaplar pegem, yök vb. yerlerden alınmış özel kitaplardır.Akademik kitaplar pegem, yök vb. yerlerden alınmış özel kitaplardır.</p>
						</div>
					</div>
				</div>
				<br>
