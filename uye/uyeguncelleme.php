						...
						<div class="col-xs-20 col-sm-20 col-md-20 col-lg-12 col-xl-12">						
							<div class="card mb-10">
								<div class="card-header">
									<h3><i class="fa fa-table"></i> Üye Güncelleme</h3>
								</div>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table id="example1" class="table table-bordered table-hover display">
											...
											<tbody>
												<?php
											$kullaniciSor=$db->prepare("SELECT * from kullanici"); //kullanici tablousundaki tüm kullanıcıları çeker
											...
											while ($kullaniciCek=$kullaniciSor->fetch(PDO::FETCH_ASSOC)) { ?>
												<tr>
													...
													<td align="center"><a href="uyeguncelleislem.php?userID=<?php echo $kullaniciCek['userID']?>"><button class="btn btn-warning" type="submit" name="guncelle">Düzenle</button></a></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
