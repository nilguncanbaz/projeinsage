		...
		<div class="content-page" >
			...
			<div class="content">
				...
				<div class="container-fluid" >
					...
					?>
					<form  method="POST" action="uyelisteguncel.php">
					...
					<div class="form-group">
							...
							<input type="password" class="form-control" name="parola"  value="<?php echo $kullaniciCek['parola'] ?>" autocomplete="off" required="">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="onay"   value="<?php echo $kullaniciCek['onay'] ?>" required="">
						</div>
